...
p1 <- ggplot(p1.data, aes(x=Day, y=log(norm_abund))) +
  ...
  geom_point(data = p1.data[p1.estimate$Start,], color="#A9A9A9") +
  geom_point(data = p1.data[p1.estimate$End,], color="#A9A9A9") +
...
p2 <- ggplot(p2.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_point(data = p2.data[p2.estimate$Start,], color="#A9A9A9") +
  geom_point(data = p2.data[p2.estimate$End,], color="#A9A9A9") +
  geom_line(color="#676366") +
...
p3 <- ggplot(p3.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_point(data = p3.data[p3.estimate$Start,], color="#A9A9A9") +
  geom_point(data = p3.data[p3.estimate$End,], color="#A9A9A9") +
  geom_line(color="#676366") +
...
p4 <- ggplot(p4.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_point(data = p4.data[p4.estimate$Start,], color="#A9A9A9") +
  geom_point(data = p4.data[p4.estimate$End,], color="#A9A9A9") +
  geom_line(color="#676366") +
...
ggsave(example.curves, file="figures/fig2_examplegrowth.png", units="mm", width=180, height=95)
```
