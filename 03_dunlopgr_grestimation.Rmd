...
load("rdata.files/gr_ucosm.norm.tax.rds")
...
# Replicate info
rep <- read.csv("replicate.metadata.csv")
...
for (l in unique(as.character(ucosm.zero$Label))) {
  datasub <- ucosm.zero[ucosm.zero$Label==l,]
  len <- nrow(datasub)
  thisrow <- data.frame(l, len)
  filter.df <- rbind(filter.df, thisrow)
}
filter.df <- filter(filter.df, len > 2)
filter.labels <- filter.df$l
ucosm.filter <- filter(ucosm.zero, Label %in% filter.labels)
...
```{r, eval = FALSE}
library(tidyverse)
gr.final <- readRDS(gr.final, file="rdata.files/gr_gr.final_rm0.rds")
...
Choosing example "growth curves" to represent diversity of taxonomies and growth rates.

```{r}
# Import data (from script 04)

# Microcosm data
ucosm <- readRDS(file="rdata.files/ucosm.norm.cleaned.rds")

# Growth rate estimations
gr.est <- readRDS(file="rdata.files/gr.final.cleaned.rds")
```
...
p1 <- ggplot(p1.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p1.data[p1.estimate$start_tp:p1.estimate$end_tp,], color="black", fill="gray", linetype=2, alpha=0.5) +
  labs(title=paste(unique(p1.data$Phylum), ", ", unique(p1.data$Genus), sep=""), y="ln normalized abundance") +
...
p2 <- ggplot(p2.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p2.data[p2.estimate$start_tp:p2.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p2.data$Phylum), ", ", unique(p2.data$Genus), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        title = element_text(size=9),
...
p3 <- ggplot(p3.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p3.data[p3.estimate$start_tp:p3.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p3.data$Phylum), ", ", unique(p3.data$Genus), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        title = element_text(size=9),
...
p4 <- ggplot(p4.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p4.data[p4.estimate$start_tp:p4.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p4.data$Phylum), ", ", unique(p4.data$Family), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        title = element_text(size=9),
...
Cowplot doesn't have a built-in method for adding axis titles that span graphs, so I'll do that in adobe illustrator.

```{r, eval=FALSE}
ggsave(plot = example.curves, file = "figures/fig_examplegrowth.pdf", device=pdf, width=180, height=95, unit="mm")
```
...
p1 = ggplot(p1.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p1.data[p1.estimate$start_tp:p1.estimate$end_tp,], color="black", fill="gray", linetype=2, alpha=0.7, size=0.6) +
  labs(title=paste(unique(p1.data$Phylum), ", ", "Paraburkholderia", sep=""), y="Normalized abundance (ln)") + # substituted genus for shortened "paraburkholderia"
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
...
p2 = ggplot(p2.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p2.data[p2.estimate$start_tp:p2.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.7, size=0.6) +
  labs(title=paste(unique(p2.data$Phylum), ", ", unique(p2.data$Genus), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
p3 = ggplot(p3.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p3.data[p3.estimate$start_tp:p3.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.7, size=0.6) +
  labs(title=paste(unique(p3.data$Phylum), ", ", unique(p3.data$Genus), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
...
p4 = ggplot(p4.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p4.data[p4.estimate$start_tp:p4.estimate$end_tp,], color="black", fill="gray", linetype=2, fill="black", alpha=0.7, size=0.6) +
  labs(title=paste(unique(p4.data$Phylum), ", ", unique(p4.data$Family), sep=""), y="Normalized abundance (ln)") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
...
# Save plots
ggsave(plot = example.curves, file = "figures/fig_examplegrowth_poster.pdf", device=pdf, width=4.7, height=2.2, unit="in")
```
...
```{r, eval=FALSE, echo=FALSE}
# Stored code to make plot with same y-axis across graphs

# Example 1: Burkholderia
p1.estimate = gr.final %>%
  filter(ASV=="13e4a5f455c50b2e805e017ca450ade2", Soil=="S17", Amendment=="Y", Replicate==1)
p1.data = ucosm.clean %>%
  filter(ASV=="13e4a5f455c50b2e805e017ca450ade2", Soil=="S17", Amendment=="Y", Replicate==1)

p1 = ggplot(p1.data, aes(x=Day, y=log.abund)) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p1.data[p1.estimate$Start:p1.estimate$End,], color="black", fill="gray", linetype=2, alpha=0.5) +
  labs(title=paste(unique(p1.data$Phylum), ", ", unique(p1.data$Genus), sep=""), y="ln normalized abundance") +
...
# Example 2: Streptomyces
p2.estimate = gr.final %>%
  filter(ASV=="aecae9d790a63cf565c1b5cdbd02ebdd", Soil=="C3", Amendment=="Y", Replicate==3)
p2.data = ucosm.clean %>%
  filter(ASV=="aecae9d790a63cf565c1b5cdbd02ebdd", Soil=="C3", Amendment=="Y", Replicate==3)

p2 = ggplot(p2.data, aes(x=Day, y=log.abund)) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p2.data[p2.estimate$Start:p2.estimate$End,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p2.data$Phylum), ", ", unique(p2.data$Genus), sep=""), y="ln normalized abundance") +
  scale_y_continuous(limits=c(-6,5)) +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
# Example 3: Acidobacteria
p3.estimate = gr.final %>%
  filter(ASV=="692a26188cb2e4528d0add62ea0d77f1", Soil=="C3", Amendment=="N", Replicate==1)
p3.data = ucosm.clean %>%
  filter(ASV=="692a26188cb2e4528d0add62ea0d77f1", Soil=="C3", Amendment=="N", Replicate==1)

p3 = ggplot(p3.data, aes(x=Day, y=log.abund)) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p3.data[p3.estimate$Start:p3.estimate$End,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p3.data$Phylum), ", ", unique(p3.data$Genus), sep=""), y="ln normalized abundance") +
  scale_y_continuous(limits=c(-6,5)) +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
...
# Example 4: Planctomyces
p4.estimate = gr.final %>%
  filter(ASV=="4b2544b81a01a3355506bfbba84889e1", Soil=="S17", Amendment=="Y", Replicate==3)
p4.data = ucosm.clean %>%
  filter(ASV=="4b2544b81a01a3355506bfbba84889e1", Soil=="S17", Amendment=="Y", Replicate==3)

p4 = ggplot(p4.data, aes(x=Day, y=log.abund)) +
  geom_point(color="#676366", shape=1) +
  geom_line(color="#676366") +
  geom_smooth(method="lm", data=p4.data[p4.estimate$Start:p4.estimate$End,], color="black", fill="gray", linetype=2, fill="black", alpha=0.5) +
  labs(title=paste(unique(p4.data$Phylum), ", ", unique(p4.data$Genus), sep=""), y="ln normalized abundance") +
  scale_y_continuous(limits=c(-6,5)) +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
...
example.curves = plot_grid(p1, p2, p3, p4, labels=c("a","b","c","d"), label_size=10)
example.curves
```
