...
habitatdist.poster = plot_grid(p1.poster, NULL, p2.poster, nrow=1, align="h", rel_widths=c(1,0.04,1), labels=c("a", NA, "b"), label_size=10)
habitatdist.poster

ggsave(plot=habitatdist.poster, file="figures/fig_habitatdist_poster.pdf", device=pdf, width=8.8, height=4.4, units="in")
```
