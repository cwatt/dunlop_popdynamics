...
field.group.ind.C3.lmer2 = lmer(log(corr_abund) ~ group + Block + group:Block + (1|Replicate), data=field.group.n16S[field.group.n16S$Soil=="C3",]) # fit model 2
...
field.group.ind.S17.lmer2 = lmer(log(corr_abund) ~ group + Block + group:Block + (1|Replicate), data=field.group.n16S[field.group.n16S$Soil=="S17",]) # fit model 2
