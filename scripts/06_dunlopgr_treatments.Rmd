...
```{r}
plot <- growth.trt %>%
  pivot_longer(c(start_day, change_abund, k, n16S), names_to = "growth_metric") %>%
  mutate(Soil = fct_recode(Soil, Cropped = "C3", Successional = "S17"),
         ...
         growth_metric = fct_recode(growth_metric, 
         'Start day' = "start_day", 
         'Change in abundance' = "change_abund", 
         'Specific growth rate' = "k",
         'rrn copy number' = "n16S")) %>%
...
ggsave(plot, filename="../figures/fig3_treatments.png", units="mm", width=180, height=60)
```
