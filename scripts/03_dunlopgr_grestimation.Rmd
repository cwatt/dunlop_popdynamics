...
p1 <- ggplot(p1.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#5a5a5a", shape=1) +
  geom_point(data = p1.data[p1.estimate$Start,], color="#5a5a5a") +
  geom_point(data = p1.data[p1.estimate$End,], color="#5a5a5a") +
...
p2 <- ggplot(p2.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#5a5a5a", shape=1) +
  geom_point(data = p2.data[p2.estimate$Start,], color="#5a5a5a") +
  geom_point(data = p2.data[p2.estimate$End,], color="#5a5a5a") +
  geom_line(color="#676366") +
...
p3 <- ggplot(p3.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#5a5a5a", shape=1) +
  geom_point(data = p3.data[p3.estimate$Start,], color="#5a5a5a") +
  geom_point(data = p3.data[p3.estimate$End,], color="#5a5a5a") +
  geom_line(color="#676366") +
...
p4 <- ggplot(p4.data, aes(x=Day, y=log(norm_abund))) +
  geom_point(color="#5a5a5a", shape=1) +
  geom_point(data = p4.data[p4.estimate$Start,], color="#5a5a5a") +
  geom_point(data = p4.data[p4.estimate$End,], color="#5a5a5a") +
  geom_line(color="#676366") +
...
ggsave(example.curves, file="figures/fig2_examplegrowth.png", units="mm", width=170, height=95)
```

Cowplot doesn't have a built-in method for adding axis titles that span graphs.
